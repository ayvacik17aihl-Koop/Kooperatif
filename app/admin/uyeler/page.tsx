                  ...
                  {uyeler.map((uye) => (
                    <tr key={uye.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="p-3 font-medium text-gray-800">
                        {uye.cari_kartlari?.tam_ad ? (
                          <span>{uye.cari_kartlari.tam_ad}</span>
                        ) : (
                          <span className="text-red-400 italic">İşlenmemiş</span>
                        )}
                      </td>
                      ...
                      <td className="p-3 font-mono">
                        <span className="text-red-600 font-semibold">
                          {uye.cari_kartlari 
                            ? (uye.cari_kartlari.toplam_borc - uye.cari_kartlari.toplam_alacak).toFixed(2) 
                            : "0.00"} TL
                        </span>
                      </td>
                      {/* Durum butonu ve Linkler aynı kalabilir... */}
                    </tr>
                  ))}
                </tbody>
              </table>
